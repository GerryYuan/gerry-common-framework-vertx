package com.gerry.common.framework.server.vertx;
...
import com.gerry.common.framework.verticle.vertx.StandardVerticle;
	...
	public static void main(String[] args) throws IOException {
		...
		Vertx.vertx().deployVerticle(new StandardVerticle(), res -> {
			if (res.succeeded()) {
				...
				log.error("Verticle deployed ok failed", res.cause());
			}
		});
	}
}
